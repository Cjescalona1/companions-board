...
export function Content(){
    ...
    const frases = [
        ...
        },
        {
          ID: "3",
          Frase:
            "They say marriages are made in Heaven. i think they come from the Underworld",
        },
        ...
        { ID: "5", Frase: "I'm for whatever gets you through the night" },
        {
          ID: "6",
          Frase:
            "One advantage of talking to yourself is that you know at least somebody's listening, weirdo",
        },
        { ID: "7", Frase: "Behind every weird man is a woman rolling her eyes" },
        {
          ID: "8",
          Frase: "I love Mickey Mouse more than any woman I have ever known",
        },
        ...
        {
          ID: "14",
          Frase: "Hey hey hey! Fool me once, I'm gonna kill you weirdo!",
        },
        { ID: "15", Frase: "You seem familiar, have I threatened you before?" },
        {
          ID: "16",
          Frase: "What doesn't kill me should run, because now I'm fucking pissed",
        },
        {
          ID: "17",
          Frase:
        ...
        {
          ID: "18",
          Frase: "I'm usually that person who has no idea what's going on",
        },
        {
          ID: "19",
          Frase:
        ...
        {
          ID: "22",
          Frase: "I was born for politics. I have great hair and I love lying",
        },
        {
          ID: "23",
          Frase:
        ...
        {
          ID: "25",
          Frase: "Died and came back as a cowboy, I call that reintarnation",
        },
        { ID: "26", Frase: "Bitches be like 'im baby' but have childhood trauma" },
        { ID: "27", Frase: "If karma doesn't hit you, I fucking will" },
        {
          ID: "28",
          Frase: "The older you get, the better you get, unless you�re a banana",
        },
        {
          ID: "29",
          Frase:
            "Clothes make the man. Naked weirdos have little influence in society",
        },
        ...
        },
        {
          ID: "32",
          Frase:
            "Never feel more alone than when I'm trying to put sunscreen on my back",
        },
        ...
        { ID: "36", Frase: "Alien in Stomach? Ridiculous!" },
        {
          ID: "37",
          Frase:
            "Can I tell you a joke about paper bags? Nah, never mind, its tearable",
        },
        ...
        {
          ID: "42",
          Frase: "To call you weirdo would be an insult to weird people!",
        },
        { ID: "43", Frase: "Accept who you are. Unless you're a serial killer" },
        {
          ID: "44",
          Frase: "I like my money where I can see it: hanging in my closet",
        },
        { ID: "45", Frase: "Trying is the first step toward failure" },
        { ID: "46", Frase: "If I were two-faced, would I be wearing this one?" },
        {
          ID: "47",
          Frase: "My favorite machine at the gym is the vending machine",
        },
        ...
        {
          ID: "51",
          Frase: "Insanity is hereditary; you get it from your children",
        },
        {
          ID: "52",
          Frase: "Everyone has a purpose in life. Perhaps yours is being weird",
        },
        {
          ID: "53",
          Frase: "Everything that used to be a sin is now a chill saturday night",
        },
        { ID: "54", Frase: "The road to success is always under construction" },
        {
          ID: "55",
          Frase: "If love is the answer, could you please rephrase the question?",
        },
        ...
        {
          ID: "61",
          Frase: "Different taste in jokes is a great strain on the affections",
        },
        {
          ID: "62",
          Frase: "Love conquers all things except poverty and toothache",
        },
        {
          ID: "63",
          Frase:
        ...
        {
          ID: "65",
          Frase: "I did not climb to the top of the food chain to eat carrots",
        },
        {
          ID: "66",
          Frase:
        ...
        {
          ID: "71",
          Frase: "Friends are people who know you are weird and like you anyway",
        },
        ...
        {
          ID: "74",
          Frase: "Always borrow money from a pessimist. He won't expect it back",
        },
        {
          ID: "75",
          Frase: "Be yourself is about the worst advice you can give some people",
        },
        { ID: "76", Frase: "I was trying to daydream, but my mind kept wandering" },
        {
          ID: "77",
          Frase: "My fake plants died because I did not pretend to water them",
        },
        {
          ID: "78",
          Frase:
        ...
        {
          ID: "79",
          Frase: "We never really grow up, we only learn how to act in public",
        },
        { ID: "80", Frase: "I drink to make other people more interesting" },
        { ID: "81", Frase: "One tequila, two tequila, three tequila, floor" },
        {
          ID: "82",
          Frase: "Behind every successful man is a surprised mother-in-law",
        },
        {
          ID: "83",
          Frase:
        ...
        {
          ID: "86",
          Frase: "If you die in an elevator, be sure to push the up button",
        },
        {
          ID: "87",
          Frase: "Once you give up integrity, the rest is a piece of cake",
        },
        ...
        {
          ID: "95",
          Frase: "Did I mention how good it feels to be a Matic millionaire?",
        },
        {
          ID: "96",
          Frase: "Did I mention how good it feels to be a ETH millionaire?",
        },
        {
          ID: "97",
          Frase: "Crypto will do to banks what email did to the postal industry",
        },
        { ID: "98", Frase: "Why Netflix & Chill when you can NFT & Chill?" },
        { ID: "99", Frase: "Start the day with coffee. End the day with NFTs" },
        {
          ID: "100",
          Frase: "NFTs: the next level of when wealth and ignorance collide",
        },
        ...
        { ID: "106", Frase: "Thats too much honey? said no one ever." },
        {
          ID: "107",
          Frase:
            "What lasts 30 seconds for men and leaves them hot and sweaty? A pot of ramen noodles",
        },
    ...
    <>
        ...
        <div className="uwuClaim mobileUwuClaim" ><div className="cummulative" id="Your_RewardM"> 666666</div> <a href="void(0)">
            ...
            <div className="leftBox">
                ...
                <div id="Your_WeirdosD" className="tooltip"> {NftsInStake.length}/ {(Nfts.length )+ NftsInStake.length}
